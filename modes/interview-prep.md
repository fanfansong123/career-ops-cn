...
对比 JD 要求与候选人 cv.md，列出差距并按紧急度排序：

### 差距分级

| 等级 | 含义 | 示例 |
|------|------|------|
| 🔴 硬缺口 | JD 明确要求，候选人完全不掌握 | 如：要求 Python 但候选人只会 Go |
| 🟡 软缺口 | JD 提到，候选人有相邻经验但不够深 | 如：要求 Agent 开发，候选人有 Camunda 流程编排经验 |
| 🟢 可映射 | JD 要求的技能可以通过现有经验重新表述来匹配 | 如：K8s部署经验 → 可映射为 AI 推理服务部署基础 |

### 学习路线

为每个 🔴 和 🟡 缺口提供：

1. **学习资源**：推荐的具体教程、文档、课程（标注免费/付费）
2. **预计时间**：从入门到能面试回答问题需要多久
3. **最低可接受水平**：学到什么程度就能在面试中不被问住
4. **面试话术**：如果还没学完，面试中如何诚实应对
...
| # | JD 要求 | 候选人现状 | 差距等级 | 学习优先级 |
|---|---------|----------|---------|----------|
| 1 | Agent/RAG/LangChain | Camunda流程编排经验，概念相通 | 🟡 | P0 |
| 2 | AI推理服务部署 | K8s+Jaeger经验可平移 | 🟢 | P1

## 学习路线

### P0: Agent/RAG/LangChain
- **学习资源:** {具体链接}
- **预计时间:** 2-3周
- **最低可接受水平:** 能讲清楚RAG原理、用LangChain搭一个demo
- **面试话术:** "我正在学，但我有丰富的流程编排经验..."
